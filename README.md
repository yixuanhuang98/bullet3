...
# change in the pybullet 
Main changes in the pybullet part is in the examples/pybullet/gym/pybullet_envs/bullet. 
We could change rewards, obstacles, states and actions. 
